...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '选择将要发射的烟花类型。 选择“随机（Random）”是一个不错的选择！'
	},
	shellSize: {
		header: '烟花大小',
		body: '以真实的烟花炮弹尺寸为模型，较大的炮弹具有更大的爆发力，带有更多的星星，有时效果更复杂。 但是，较大的尺寸还需要更多的处理能力，并且可能会导致延迟。'
	},
	quality: {
		header: '画质',
		body: '整体图形质量。 如果动画运行不流畅，请尝试降低质量。 高质量会大大增加产生的火花数量，并可能导致设备卡顿。'
	},
	skyLighting: {
		header: '照亮天空',
		body: '烟花爆炸时会照亮背景。 如果在屏幕上看起来太亮，请尝试将其设置为“暗淡”或“无”。'
	},
	scaleFactor: {
		header: '缩放',
